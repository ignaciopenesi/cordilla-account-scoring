...
| `ACC-00122` | #7 | 14.8% | 6 | web | — | 38d | skip → `control` | — | calling never helped this segment |
| `ACC-00646` | #8 | 14.8% | 6 | mql | — | 272d | skip → `control` | — | calling never helped this segment |
| `ACC-00265` | #14 | 12.2% | 5 | trial | yes | 93d | ask → `ask` | — | sunk cost — the rep answers first |
| `ACC-00146` | #16 | 12.2% | 5 | trial | yes | 192d | ask → `control` | — | sunk cost — the rep answers first |
...
| `ACC-00101` | #30 | 10.7% | 6 | vendor | — | 140d | ask → `control` | — | sunk cost — the rep answers first |
...
| account | model rank | score | contacts | segment | trial | age | here | evidence | why |
|---|---|---|---|---|---|---|---|---|---|
| `ACC-01404` | #64 | 8.4% | 0 | trial | yes | 105d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-01394` | #57 | 8.8% | 0 | trial | yes | 81d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00011` | #137 | 5.7% | 0 | trial | yes | 148d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00200` | #68 | 8.3% | 0 | trial | yes | 116d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00086` | #108 | 6.5% | 0 | trial | yes | 109d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00552` | #104 | 6.8% | 0 | trial | yes | 82d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00264` | #110 | 6.4% | 0 | trial | yes | 45d | first-call → `control` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00076` | #34 | 10.3% | 0 | trial | yes | 87d | first-call → `first-call` | +5.0 pts uplift (train) | called this week |
...
| `ACC-01151` | #102 | 6.9% | 0 | trial | yes | 61d | first-call → `first-call` | +5.0 pts uplift (train) | called this week |
| `ACC-01091` | #114 | 6.3% | 0 | trial | yes | 457d | first-call → `first-call` | +5.0 pts uplift (train) | called this week |
| `ACC-00483` | #126 | 5.9% | 0 | trial | yes | 32d | first-call → `first-call` | +5.0 pts uplift (train) | called this week |
| `ACC-00433` | #136 | 5.7% | 0 | trial | yes | 515d | first-call → `observe` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00802` | #36 | 10.2% | 0 | trial | yes | 113d | first-call → `observe` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-00285` | #95 | 7.1% | 0 | trial | yes | 143d | first-call → `observe` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
| `ACC-01269` | #122 | 6.0% | 0 | trial | yes | 598d | first-call → `observe` | +5.0 pts uplift (train) | held back at random — the control for the +10 |
...
## Buried by the model, called first here — 17 accounts
...
| account | model rank | score | contacts | segment | trial | age | here | evidence | why |
|---|---|---|---|---|---|---|---|---|---|
| `ACC-01271` | #225 | 4.4% | 2 | vendor | — | 113d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00093` | #219 | 4.4% | 2 | vendor | — | 403d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00619` | #217 | 4.5% | 3 | vendor | — | 311d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00707` | #216 | 4.5% | 2 | vendor | — | 71d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-01145` | #215 | 4.5% | 3 | vendor | — | 304d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00561` | #208 | 4.5% | 2 | vendor | — | 437d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-01185` | #207 | 4.6% | 2 | vendor | — | 69d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00586` | #206 | 4.6% | 2 | vendor | — | 157d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-01225` | #198 | 4.7% | 3 | vendor | — | 53d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00779` | #197 | 4.7% | 3 | vendor | — | 96d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-01456` | #192 | 4.7% | 3 | vendor | — | 96d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
| `ACC-00722` | #178 | 4.8% | 2 | vendor | — | 469d | continue → `continue` | 7.3% in conversation (train) | vendor segment, in conversation |
